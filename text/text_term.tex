...
векторная маска, \pageref{term:vector_mask}, \pageref{term:vector_mask2}, \pageref{term:vector_mask3}, \pageref{term:vector_mask4}
...
метод векторизации в проверкой векторных масок, \pageref{term:meth_vec_check}
...
ширина векториазации, \pageref{term:vec_shir}, \pageref{term:vec_shir2}
...
эффективность векторизации, \pageref{term:vec_eff}, \pageref{term:vec_eff2}, \pageref{term:vec_eff3}
