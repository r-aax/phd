...
\newpage
\section*{Глава 4. Повышение производительности расчетных кодов с помощью векторизации}                      % выключить номер первой главы
\addcontentsline{toc}{section}{Глава 4. Повышение производительности расчетных кодов с помощью векторизации} % но добавить ее в оглавление
\addtocounter{section}{1}                                                                                    % а теперь и счетчик продвинуть
\setcounter{subsection}{0}
\setcounter{figure}{0}
\setcounter{equation}{0}
