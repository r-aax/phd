...
\textbf{МГД} -- МагнитоГидроДинамический, \pageref{abbr:mgd-1}
...
\textbf{AMR} -- Adaptive Mesh Refinement, \pageref{abbr:amr-1}
...
\textbf{CPU} -- Central Processing Unit, \pageref{abbr:cpu-1}, \pageref{abbr:cpu-2}

\textbf{CVT} -- Centroidal Voronoi Tesselation, \pageref{abbr:cvt-1}

\textbf{DGM} -- Discontinuous Galerkin Method, \pageref{abbr:dgm-1}

\textbf{DQ} -- Doubleword and Quadword, \pageref{abbr:dq-1}

\textbf{DT} -- Delaunay Triangulation, \pageref{abbr:dt-1}
...
\textbf{GPU} -- Graphics Processing Unit, \pageref{abbr:gpu-1}, \pageref{abbr:gpu-2}

\textbf{ICAM} -- International Conference on Aviation Motors, \pageref{abbr:icam-1}
...
\textbf{LS} -- Laplacian Smoothing, \pageref{abbr:ls-1}
...
\textbf{VLIW} -- Very Long Instruction Word, \pageref{abbr:vliw-1}
...
\textbf{VOF} -- Volume Of Fluid, \pageref{abbr:vof-1}
